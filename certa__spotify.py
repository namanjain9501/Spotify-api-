...
# username = '31yec3gvxazvfo4dxcscihhhlytm'

# token = SpotifyOAuth(scope=scope,username=username)
# spotifyObject = spotify.Spotify(auth_manager = token)

# playlist_name = input("Enter a playlist name")
# playlist_description = input("Enter the playlist description")

# spotifyObject.user_playlist_create(username=username,name=playlist_name,public=True,description=playlist_description)
